---
title: "Hello World - Scala using Play"
linkTitle: "Scala"
weight: 1
type: "docs"
---
...
Serving when using [Scala](https://scala-lang.org/) and [Play](https://www.playframework.com/). 
...
cd knative-docs/docs/serving/samples/hello-world/helloworld-scala-play
```
